...
namespace CB\Plugin\ContentbuilderngValidation\DateNotBefore\Extension;
...
final class DateNotBefore extends CMSPlugin implements SubscriberInterface
{
        private const VALIDATION_NAME = 'date_not_before';
